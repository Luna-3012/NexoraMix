...
class ImageGenerationService:
    ...
    def _get_placeholder_image(self, brand1: str, brand2: str) -> str:
        """Generate a placeholder image URL with proper URL encoding"""
        # URL encode the brand names to handle special characters
        encoded_brand1 = urllib.parse.quote(brand1)
        encoded_brand2 = urllib.parse.quote(brand2)
        placeholder_url = f"https://via.placeholder.com/1024x1024/4A90E2/FFFFFF?text={encoded_brand1}+x+{encoded_brand2}"
