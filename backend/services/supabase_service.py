...
class SupabaseService:
    ...
    def create_combo(self, combo_data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if not insert_data["name"] or not insert_data["product1"] or not insert_data["product2"]:
                LOG.error("Missing required fields for combo creation")
                return None
    ...
    def get_leaderboard(self, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        if not self.client:
            LOG.warning("Supabase not available for leaderboard")
            return []
    ...
    def vote_for_combo(self, combo_id: str) -> bool:
        ...
        if not self.client:
            LOG.warning("Supabase not available for voting")
            return False
