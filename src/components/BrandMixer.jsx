    ...
    return (
        <div className="service-status">
            ...
            <div className="status-grid">
                <div className={`status-item ${status?.claude_ai ? 'active' : 'inactive'}`}>
                    Claude AI: {status?.claude_ai ? '✓' : '✗'}
                </div>
                <div className={`status-item ${status?.image_gen ? 'active' : 'inactive'}`}>
                    Image Gen: {status?.image_gen ? '✓' : '✗'}
                </div>
                <div className={`status-item ${status?.database ? 'active' : 'inactive'}`}>
                    Database: {status?.database ? '✓' : '✗'}
                </div>
                <div className={`status-item ${status?.knowledge_base ? 'active' : 'inactive'}`}>
                    Knowledge: {status?.knowledge_base ? '✓' : '✗'}
                </div>
            </div>
        </div>
    );
